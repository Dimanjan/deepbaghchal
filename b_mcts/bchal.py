...
_TTTB = namedtuple("BaghChalBoard", "tup turn winner terminal")

# Inheriting from a namedtuple is convenient because it makes the class
# immutable and predefines __init__, __repr__, __hash__, __eq__, and others
class BaghChalBoard(_TTTB, Node):
    ...
    def make_move(board, index):
        ...
        return BaghChalBoard(tup, turn, winner, is_terminal)
...
def new_tic_tac_toe_board():
    return BaghChalBoard(tup=(None,) * 9, turn=True, winner=None, terminal=False)
